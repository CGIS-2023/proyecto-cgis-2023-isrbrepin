    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">{{__('Editar a ')}} {{$medico->user->name}}</a>
              </li>
            </ol>
          </nav>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="POST" action="{{ route('medicos.update', $medico->id) }}">
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="telefono" class="block mt-1 w-full" type="text" name="telefono" :value="$medico->telefono" required />
                            </div>
