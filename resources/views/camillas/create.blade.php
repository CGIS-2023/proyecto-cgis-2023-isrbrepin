    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">Crear camilla</a>
              </li>
            </ol>
          </nav>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="font-semibold text-lg px-6 py-4 bg-white border-b border-gray-200">
                    Información de la camilla
                </div>
                <div class="p-6 bg-white border-b border-gray-200">
                        <!-- Validation Errors -->
                        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                        <form method="POST" action="{{ route('camillas.store') }}">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-input id="precio" class="block mt-1 w-full" type="text" name="precio" :value="old('precio')" required autofocus />
                            </div>

                            <div>
                                    <x-label for="fecha_adquisicion" :value="__('Fecha de Adquisicion')" />

                                    <x-input id="fecha_adquisicion" class="block mt-1 w-full" type="date" name="fecha_adquisicion" :value="old('fecha_adquisicion')" required autofocus />
                                </div>
